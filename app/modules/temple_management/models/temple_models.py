...
class PortalAnalyticsEventType(str, enum.Enum):
    ...
    POPULAR_CHIP_CLICK = "POPULAR_CHIP_CLICK"
    TEMPLE_CARD_CLICK = "TEMPLE_CARD_CLICK"
    FESTIVAL_CLICK = "FESTIVAL_CLICK"
    CAROUSEL_SCROLL = "CAROUSEL_SCROLL"
    SUGGEST_TEMPLE_CLICK = "SUGGEST_TEMPLE_CLICK"
    CLAIM_TEMPLE_CLICK = "CLAIM_TEMPLE_CLICK"
    TEMPLE_VIEW = "TEMPLE_VIEW"
    CLAIM_CTA_IMPRESSION = "CLAIM_CTA_IMPRESSION"
